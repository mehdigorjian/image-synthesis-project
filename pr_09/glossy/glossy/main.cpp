...
int main() {
    ...
    //    {
    //    Material      ivory(1.0 + j, Vec4f(0.6,  0.3, 0.1, 0.0), Vec3f(0.4, 0.4, 0.3),   50.);
    //    Material      glass(1.5 + j, Vec4f(0.3,  0.5, 0.1, 0.4), Vec3f(0.6, 0.7, 0.8),  850.);
    //    Material red_rubber(1.0 + j, Vec4f(0.9,  0.1, 0.0, 0.0), Vec3f(0.3, 0.1, 0.1),   10.);
    //    Material     mirror(1.0 + j, Vec4f(0.0, 10.0, 0.8, 0.0), Vec3f(1.0, 1.0, 1.0), 1425.);
    //
    //    std::vector<Sphere> spheres;
    ////    spheres.push_back(Sphere(Vec3f(-3, 3.5, -16), 2, ivory));
    ...
    //
    //    render(j, spheres, lights);
    //    }
    //
    //    PART 1 (MOVING OBJECTS) | PART 3 (MOVING CAMERA)
    for (float i = 0; i < 10; i+=.5)
    {
        std::vector<Sphere> spheres;
        //PART 1
        //    spheres.push_back(Sphere(Vec3f(-3, 3.5, -16), 2, ivory));
        //    spheres.push_back(Sphere(Vec3f(-1.0 + i, -1.5, -12), 3, glass));
        //    spheres.push_back(Sphere(Vec3f( 2.5 + i, -.5, -18), 3, red_rubber));
        //    spheres.push_back(Sphere(Vec3f( 4 + i, 6, -18), 3.5, mirror));
        //PART 3
        spheres.push_back(Sphere(Vec3f(-1.0, -1.5, -12), 3, glass));
        spheres.push_back(Sphere(Vec3f( 2.5, -.5, -18), 3, red_rubber));
        spheres.push_back(Sphere(Vec3f( 4, 6, -18), 3.5, mirror));
